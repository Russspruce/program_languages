...
public class LanguageTest {
  ...
  public void equals_returnsTrueIfNamesAretheSame_true() {
    Language firstLanguage = new Language("Java", "Example text goes here for now", "More example text for now.", "May 23rd, 1995", "http://java.com");
    Language secondLanguage = new Language("Java", "Example text goes here for now", "More example text for now.", "May 23rd, 1995", "http://java.com");
